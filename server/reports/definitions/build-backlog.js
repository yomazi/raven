 ...
 *
 * One row per show, showing all build-phase statuses with color coding,
...
const FOLDER_ID = process.env.REPORT_BUILD_BACKLOG ?? "REPLACE_WITH_DRIVE_FOLDER_ID";
...
const STATUS_COLORS = {
  ...
  "to do": rgb(255, 255, 255), // white — untouched
  "n/a": rgb(217, 217, 217), // grey — not applicable
